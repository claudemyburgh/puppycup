...
export default function ContactPages() {
  return (
    <div className="min-h-screen bg-white">
      <header className="bg-blue-gray-800 relative pb-36">
            ...
            <div className="flex flex-1 items-center">
              <div className="flex w-full items-center justify-between lg:w-auto">
                ...
                <div className="-mr-2 flex items-center lg:hidden">
                  <Popover.Button className="bg-blue-gray-900 focus-ring-inset inline-flex items-center justify-center rounded-md bg-opacity-0 p-2 text-white hover:bg-opacity-100 focus:outline-none focus:ring-2 focus:ring-white">
            ...
            >
              <div className="overflow-hidden rounded-lg bg-white shadow-lg ring-1 ring-black ring-opacity-5">
                <div className="flex items-center justify-between px-5 pt-4">
                  ...
                  <div className="-mr-2">
                    <Popover.Button className="text-blue-gray-400 hover:bg-blue-gray-100 inline-flex items-center justify-center rounded-md bg-white p-2 focus:outline-none focus:ring-2 focus:ring-inset focus:ring-blue-500">
                  ...
                  <div className="space-y-1 px-2">
                    {navigation.map((item) => (
                      <a
                        key={item.name}
                        href={item.href}
                        className="text-blue-gray-900 hover:bg-blue-gray-50 block rounded-md px-3 py-2 text-base font-medium"
                      >
                        {item.name}
                      </a>
                    ))}
      ...
      <main>
        <div className="bg-blue-gray-50">
          ...
          >
            <h2
              className="text-blue-gray-900 text-3xl font-extrabold"
              id="faq-heading"
            >
              ...
              <dl className="space-y-10 md:grid md:grid-cols-2 md:grid-rows-2 md:gap-x-8 md:gap-y-12 md:space-y-0">
                {faqs.map((faq) => (
                  <div key={faq.id}>
                    ...
                    <dd className="text-blue-gray-500 mt-2 text-base">
                      {faq.answer}
                    </dd>
                  </div>
                ))}
      ...
      <footer className="bg-blue-gray-50" aria-labelledby="footer-heading">
        ...
        <div className="mx-auto max-w-md py-12 px-4 sm:max-w-7xl sm:px-6 lg:py-16 lg:px-8">
          <div className="xl:grid xl:grid-cols-3 xl:gap-8">
            ...
            <div className="mt-12 grid grid-cols-2 gap-8 xl:col-span-2 xl:mt-0">
              <div className="md:grid md:grid-cols-2 md:gap-8">
                <div>
                  <h3 className="text-blue-gray-400 text-sm font-semibold uppercase tracking-wider">
                    Solutions
                  </h3>
                  <ul role="list" className="mt-4 space-y-4">
                    {footerNavigation.solutions.map((item) => (
                      <li key={item.name}>
                        <a
                          href={item.href}
                          className="text-blue-gray-500 hover:text-blue-gray-900 text-base"
                        >
                          {item.name}
                        </a>
                      </li>
          ...
          <div className="border-blue-gray-200 mt-12 border-t pt-8">
            <p className="text-blue-gray-400 text-base xl:text-center">
