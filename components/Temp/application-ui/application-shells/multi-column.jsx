        ...
        <div className="flex w-20 flex-col">
          <div className="flex min-h-0 flex-1 flex-col overflow-y-auto bg-indigo-600">
            <div className="flex flex-1 flex-col">
              <div className="flex flex-shrink-0 items-center justify-center bg-indigo-700 py-4">
                <img
                  className="h-8 w-auto"
        ...
        <main className="flex flex-1 overflow-hidden">
          <div className="flex flex-1 xl:overflow-hidden">
            ...
            <aside className="hidden lg:order-first lg:block lg:flex-shrink-0">
              <div className="relative flex h-full w-96 flex-col border-r border-gray-200 bg-white">
                {/* Your content */}
              </div>
            </aside>
          </div>
